* TODOs
- [ ] Refactor the Category module to expose a "factory".
- [ ] Give an *automated* construction of the identity GraphHom.
- [ ] Give an *automated* construction of the composite of two GraphHoms
      (GraphHom.compose)
- [ ] Prove that there is a category of Graphs.
- [ ] Prove that the category Graph has products.
...
- [ ] Expose clearbody in Ltac2.
- [ ] Improve sfirstorder to do intros.
